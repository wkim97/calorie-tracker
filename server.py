...
AI_SYSTEM_PROMPT = (
    ...
    "실물 사진이 있으면 사진에 보이는 양이 곧 실제 섭취량의 최종 상태다 — "
    "코멘트에 '추가'라는 표현이 있어도 사진에 이미 보이는 것이면 이중으로 더하지 마라. "
